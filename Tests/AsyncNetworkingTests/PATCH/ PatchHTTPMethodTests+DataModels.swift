//
//  PatchHTTPMethodTests+DataModels.swift
//  AsyncNetworking
//
...
/// This extension defines custom data models used for testing the `PATCH` HTTP method in the `AsyncNetworkManager` class.
...
///
///
/// - Note: These data models are specific to the test cases in the `PutHTTPMethodTests` class and are used to simulate responses from the server. They serve the purpose of validating the `AsyncNetworkManager`'s handling of data encoding and decoding for `PATCH` HTTP requests.

extension PatchHTTPMethodTests {
